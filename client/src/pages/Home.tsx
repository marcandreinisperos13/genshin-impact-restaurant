...
export default function Home() {
  return (
    <div className='min-h-screen center-flex flex-col bg-[linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url("/src/assets/home-bg.jpg")] bg-cover bg-center'>
      ...
      <h3 className='mb-10 mt-3 text-xl text-[var(--secondary-text-color)]'>A world of flavors awaits you</h3>
      <Link to="/menu" className='button px-6 py-2 transition'>Go to Menu</Link>
    </div>
  )
}
